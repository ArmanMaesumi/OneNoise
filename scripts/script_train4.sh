...
#SBATCH -J onenoise_emb_penalty2_tilefix
#SBATCH -N 1
#SBATCH -n 32
#SBATCH --mem=256g
...
#SBATCH --export=CXX=g++
#SBATCH -o /users/amaesumi/logs/onenoise_emb_penalty2_tilefix.out
#SBATCH -e /users/amaesumi/logs/onenoise_emb_penalty2_tilefix.err
